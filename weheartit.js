...
async function Login(tab , login , pwd , email){
    ...
    {   await tab.goto(login , {
        ...
        await tab.type("#user_email_or_username" , email , {delay:200}) ;

        await tab.waitForSelector("#user_password_login") ;
        await tab.type("#user_password_login" , pwd , {delay:200}) ;
...
async function Search(tab){
    ...
    await tab.type('#text' , search , {delay:200} ) ;
...
try{
        await tab.waitForSelector("#text") ;
        await tab.type('#text' , searchProfile , {delay:200} ) ;
        await tab.keyboard.press("Enter") ;
...
async function addToCollections(tab){
    ...
    {   await tab.waitForSelector("#current_user");
        ...
        await tab.type(".input-block.js-set-name-field",collectionName,{delay:200}) ;
...
async function screenShot(tab){
    ...
    await tab.waitForSelector("#text") ;
    await tab.type('#text' , ss , {delay:200} ) ;
    await tab.keyboard.press("Enter") ;
...
async function share(tab)
 {  
    try{
        ...
        await tab.waitForSelector("#text") ;
        await tab.type('#text' , "adorable puppies" , {delay:200} ) ;
        await tab.keyboard.press("Enter") ;
...
async function fb(tab1)
{
    try
    {
        ...
        await tab1.type("#email",email,{delay:200});

        await tab1.waitForSelector("#pass") ;
        await tab1.type("#pass" , p , {delay:200}) ;
        ...
        await tab1.type("textarea[title='Say something about this...']", tumblr_msg,{delay:200});
